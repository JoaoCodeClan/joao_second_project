...
public class TableTest {
    ...
    public void canCollectPaymentIfSplit(){
        table.addClient(patron1);
        table.addClient(patron2);
        menu.addDish(dish1);
        menu.addDish(dish2);
        ...
        double actual3= patron1.getBill();
        assertEquals(0, actual3, 0.01);
        double actual4= patron2.getBill();
    ...
    public void canCollectPaymentForOneClientOnly(){
        table.addClient(patron1);
        table.addClient(patron2);
        menu.addDish(dish1);
        menu.addDish(dish2);
        ...
        assertEquals(11.25,actual,0.01);
        table.collectPayment();
        double actual1=patron2.getBill();
        assertEquals(0,actual1,0.01);
